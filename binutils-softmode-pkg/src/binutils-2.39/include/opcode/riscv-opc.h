...
#define MATCH_MLBLOAD 0x2b
#define MASK_MLBLOAD 0xfff0707f
#define MATCH_MLBSTORE 0x102b
#define MASK_MLBSTORE 0xfff0707f

#define MATCH_PLBLOAD 0x202b
#define MASK_PLBLOAD 0xfff0707f
#define MATCH_PLBSTORE 0x302b
#define MASK_PLBSTORE 0xfff0707f

 #define MATCH_CCALL 0x200b
 #define MASK_CCALL 0xffffffff

 #define MATCH_PCALL 0xb
 #define MASK_PCALL 0xffffffff

#define MATCH_CRETURN 0x300b
 #define MASK_CRETURN 0xffffffff

 #define MATCH_PRETURN 0x100b
 #define MASK_PRETURN 0xffffffff
 #define MATCH_MEPCLOAD 0x402b 
 #define MASK_MEPCLOAD 0xfff0707f 
 #define MATCH_MEPCSTORE 0x502b 
 #define MASK_MEPCSTORE 0xfff0707f 
...
#define CSR_MODEID 0x800
#define CSR_TARGETMODE 0x801
#define CSR_CCALLADDR 0x802
...
DECLARE_INSN(creturn, MATCH_CRETURN, MASK_CRETURN)
DECLARE_INSN(pcall, MATCH_PCALL, MASK_PCALL)
DECLARE_INSN(preturn, MATCH_PRETURN, MASK_PRETURN)
DECLARE_INSN(mlbload, MATCH_MLBLOAD, MASK_MLBLOAD)
DECLARE_INSN(mlbstore, MATCH_MLBSTORE, MASK_MLBSTORE)
DECLARE_INSN(plbload, MATCH_PLBLOAD, MASK_PLBLOAD)
DECLARE_INSN(plbstore, MATCH_PLBSTORE, MASK_PLBSTORE)
 DECLARE_INSN(mepcload, MATCH_MEPCLOAD, MASK_MEPCLOAD) 
 DECLARE_INSN(mepcstore, MATCH_MEPCSTORE, MASK_MEPCSTORE)
...
DECLARE_CSR(modeid, CSR_MODEID, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(targetmode,  CSR_TARGETMODE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(ccalladdr, CSR_CCALLADDR, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
#endif /* DECLARE_CSR */
