...
{"ccall",       0, INSN_CLASS_I, "", MATCH_CCALL, MASK_CCALL, match_opcode, 0},
{"creturn",       0, INSN_CLASS_I, "", MATCH_CRETURN, MASK_CRETURN, match_opcode, 0},
{"pcall",       0, INSN_CLASS_I, "", MATCH_PCALL, MASK_PCALL, match_opcode, 0},
{"preturn",       0, INSN_CLASS_I, "", MATCH_PRETURN, MASK_PRETURN, match_opcode, 0},

{"mlbload", 0, INSN_CLASS_I, "d,s", MATCH_MLBLOAD, MASK_MLBLOAD, match_opcode, 0},
{"mlbstore", 0, INSN_CLASS_I, "d,s", MATCH_MLBSTORE, MASK_MLBSTORE, match_opcode, 0},
{"plbload", 0, INSN_CLASS_I, "d,s", MATCH_PLBLOAD, MASK_PLBLOAD, match_opcode, 0},
{"plbstore", 0, INSN_CLASS_I, "d,s", MATCH_PLBSTORE, MASK_PLBSTORE, match_opcode, 0},
{"mepcstore", 0, INSN_CLASS_I, "d,s", MATCH_MEPCSTORE, MASK_MEPCSTORE, match_opcode, 0},
{"mepcload", 0, INSN_CLASS_I, "d,s", MATCH_MEPCLOAD, MASK_MEPCLOAD, match_opcode, 0},
/* Terminate the list.  */
